...
(async () => {
  ...
  //"https://www.amazon.in/s?k=furniture",
    //  "https://www.amazon.in/s?k=furniture&page=2&qid=1726934706&ref=sr_pg_2",
    //  "https://www.amazon.in/s?k=furniture&page=3&qid=1726934706&ref=sr_pg_3",
    // "https://www.amazon.in/s?k=furniture&page=3&qid=1726934706&ref=sr_pg_4",
    //  "https://www.amazon.in/s?k=furniture&page=3&qid=1726934706&ref=sr_pg_5"
  // Array of Amazon search result page URLs for L4 categories
  const urls = [
    "https://www.amazon.in/s?k=furniture&page=2&qid=1726934706&ref=sr_pg_6",
     "https://www.amazon.in/s?k=furniture&page=3&qid=1726934706&ref=sr_pg_7"];
;
  const productData = [];
  ...
  // Write CSV to a file
  fs.writeFileSync('furniture_product_reviews_with_price2.csv', csvContent, 'utf8');

  console.log('Data written to furniture_product_reviews_with_price.csv');
